...
public class AccountController extends BaseController {  
	...
	public String logout(HttpServletRequest request){
		AuthHelper.removeSessionAccountAuth(request, null);
	...
	public String userInfo(HttpServletRequest request,Model model){
		...
		UserInfoModel userInfo = new UserInfoModel(account.getId(),account.getUsername(),account.getName(),account.getEmail(),account.getPassword());
